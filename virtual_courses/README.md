...
```diff
- After taking each  the courses below, we will appreciate if you could fill out
the <a href="https://www.surveymonkey.com/r/DKLWR3S">SURVEY</a> (takes about 5 minutes).
```
